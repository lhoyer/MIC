...
_base_ = [
    ...
    '../_base_/datasets/uda_brain_hcp1-hcp2_256x256_strong_crop.py',
...
name = f'brain_hcp1-hcp2_daformer4_{int(per_image)}rcs{class_temp:.1f}_strong_{loss_name}_norm_hrda'
exp = 'basic'
