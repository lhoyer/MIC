...
name = f'debug-{dataset}{datatag}_daformer1{norm_flag}_{int(per_image)}rcs{class_temp:.1f}_{loss_name}-{loss_name_teacher}{mix_flag}{burnin_flag}'
exp = 'basic'
