...
uda = dict(
    ...
    contrastive_loss=dict(type='ContrastMixCELoss', 
        use_sigmoid=False,         
        loss_weight=1.0,
        temperature=0.1,
...
name = f'debug-brain_{dataset}{datatag}_segformer{norm_flag}_{int(per_image)}rcs{class_temp:.1f}_{loss_name}-{loss_name_teacher}_contrast_detached'
exp = 'basic'
