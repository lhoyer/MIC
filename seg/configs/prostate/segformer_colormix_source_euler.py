...
uda = dict(color_mix=dict(freq=0.5, suppress_bg=True))
norm_net = dict(norm_activation="mlp", layers=[1, 128, 1])
...
norm = f"{norm_net['norm_activation']}{num_norm_layers}-throriginal"
