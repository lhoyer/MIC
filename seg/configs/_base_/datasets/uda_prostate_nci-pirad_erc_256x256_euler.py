...
source_train_pipeline = [
    ...
    # dict(type='RandomCrop', crop_size=(180, 180), cat_max_ratio=0.75),
    # dict(type='Resize', img_scale=img_scale),
...
target_train_pipeline = [
    ...
    dict(type='Resize', img_scale=img_scale),
    dict(type='StructuralAug', data_aug_ratio=0.25),
    # dict(type='RandomCrop', crop_size=(180, 180)),
    # dict(type='Resize', img_scale=img_scale),
    dict(type='RandomFlip', prob=0.5),
    # dict(type='MedPhotoMetricDistortion', data_aug_ratio=0.25),
    dict(type='PhotoMetricDistortion'),  # is applied later in dacs.py
...
data = dict(
    ...
    train=dict(
        ...
        source=dict(
            ...
            data_root='/cluster/work/cvl/klanna/prostate/nci/',
            img_dir='images/train',
            ann_dir='labels/train',
            pipeline=source_train_pipeline),
        target=dict(
            type='prostateDataset',
            data_root='/cluster/work/cvl/klanna/prostate/pirad_erc/',
            img_dir='images/train',
            ann_dir='labels/train',
