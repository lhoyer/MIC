...
data_root = 'da_data/cardiac/acdc/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        source=dict(
            type='cardiacDataset',
            data_root='/itet-stor/klanna/bmicdatasets_bmicnas02/Sharing/klanna/da_data/cardiac/acdc/',
            img_dir='images/train',
            ann_dir='labels/train',
            pipeline=source_train_pipeline),
        target=dict(
            type='cardiacDataset',
            data_root='/itet-stor/klanna/bmicdatasets_bmicnas02/Sharing/klanna/da_data/cardiac/rvsc/',
            img_dir='images/train',
            ann_dir='labels/train',
