...
source_train_pipeline = [
    ...
    # dict(type='StructuralAug', data_aug_ratio=1.0),
    # dict(type='MedPhotoMetricDistortion', data_aug_ratio=1.0),
...
data = dict(
    ...
    train=dict(
        ...
        source=dict(
            type='BrainDataset',
            data_root='/itet-stor/klanna/bmicdatasets_bmicnas02/Sharing/klanna/da_data/brain/hcp1_full/',
