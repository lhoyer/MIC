...
class PixelContrastBalanceLoss(nn.Module):
    def __init__(self, temperature=0.1, base_temperature=0.1, ignore_label=0, max_samples=256*256*15, max_views=8):
        super(PixelContrastBalanceLoss, self).__init__()
...
class ContrastBalanceCELoss(nn.Module):
    """CrossEntropyLoss.
    ...
    def __init__(self,
                 ...
                 class_weight=None,
                 loss_weight=1.0):
        super(ContrastBalanceCELoss, self).__init__()
        ...
        self.pixel_contrast = PixelContrastBalanceLoss()
    ...
    def forward(self,
        ...
        _, predict = torch.max(cls_score, 1)    
